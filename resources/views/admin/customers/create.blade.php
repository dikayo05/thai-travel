<x-layouts.admin.app>
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create Customer</h1>
    </div>
    ...
    <form action="{{ route('admin.customers.store') }}" method="POST"
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
            <label class="inline-flex items-center space-x-3 cursor-pointer">
                ...
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Mark email as verified</span>
            </label>
        </div>
